...
class ClientScreenReciever extends Thread {
    ...
    public ClientScreenReciever(Socket cSocket, JPanel p) {
        try {
            cPanel = p;
            ...
            System.out.println("ClientScreenReceiver Exception---------------- "+e);
        }
    }
    ...
    public void run() {
        try {
            ...
            try{
                ...
                System.out.println("Socket already closed-----1-----------"+e);
            }
            ...
            try{
                ...
                System.out.println("Socket already closed-------2----------"+e);
            }
        }
    }
}
