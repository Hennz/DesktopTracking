...
class ClientCommandsSender implements KeyListener,
    ...
    ClientCommandsSender(Socket s, JPanel p, Rectangle r) {
        System.out.println("command sender constructor called----------------------------");
        cSocket = s;
        cPanel = p;
        clientScreenDim = r;
        //Associate event listners to the panel
        System.out.println("Associate event listners to the panel");
        ...
        try {
             ...
             //the client
            System.out.println("Prepare PrintWriter which will be used to send commands to");
